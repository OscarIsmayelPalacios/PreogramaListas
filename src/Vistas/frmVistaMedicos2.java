 ...
 * @author umg
 */
public class frmVistaMedicos2 extends javax.swing.JDialog {

    /**
     * Creates new form frmVistaMedico2
     */
    public frmVistaMedicos2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVistaMedicos2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmVistaMedicos2 dialog = new frmVistaMedicos2(new javax.swing.JFrame(), true);
